...
# write temp file and then run test - as noted this is the worst part of the code
vertexNames = ['A', 'B', 'C']
for triple in triples:
    ...
    for i in range(3): # there are always three sequences
        ...
        pvalue = float(subprocess.check_output(["HYPHYMP","testTriple.bf"])) #testTriple.bf must be in the current directory
...
# print a brief summary to standard out
